    ...
    <AnimationWrapper>
      <section className='prose pros-base'>
        ...
        <div className='mb-5 flex items-center w-full gap-2 md:gap-2'>
          ...
          >
            <button className='btn btn-outline hover:btn-active btn-info  w-full md:btn-wide'>
              <LinkedInIcon />
            </button>
          </a>
          <a className='flex-1' rel='noopener noreferrer' target='_blank' href='https://github.com/konstagap'>
            <button className='btn btn-outline hover:btn-active btn-secondary w-full md:btn-wide'>
              <GitHubIcon />
            </button>
          </a>
        </div>
